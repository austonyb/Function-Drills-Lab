...
// console.log(greeting("Mackenzie"))
...
// console.log(exclaimThree("it works"))
...
const upperCaseFunction = (string) => console.log(string.toUpperCase())

upperCaseFunction("make this all caps")
...
const emailCheck = (email) =>{
  ...
  if (email.includes("@")){
    ...
    return "must provide a valid email adddress."
  }
}

// console.log(emailCheck("   auston@example.com  "))
...
const howManyFrogs = (gold) =>{
  return Math.floor(gold / 3)
}

totalFrogs = howManyFrogs(20)
...
const isArrayinAscendingOrder = (arr) =>{
  let checker = arr[0]
  for (i = 1; i < arr.length; i++){
    if (arr[i] >  checker) {
      console.log("continue, i =" + arr[i])
      checker = arr[i]
      continue
    } else {
      console.log("the next number is less than or equal to" + checker)
      return false
    }
  }
}

arrayIsAscending = isArrayinAscendingOrder(sampleArray)
